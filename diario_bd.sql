...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2024 a las 02:48:52
...
--
-- Estructura de tabla para la tabla `datospdf`
--

CREATE TABLE `datospdf` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `datospdf`
--

INSERT INTO `datospdf` (`id`, `fullname`, `phone`, `email`) VALUES
(12, 'francisco', '123', 'leanortizg@hotmail.com');
...
--
-- Indices de la tabla `datospdf`
--
ALTER TABLE `datospdf`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `datospdf`
--
ALTER TABLE `datospdf`
